...
namespace FileStatistic
{
    class Program
    {
        ...
        {
            Console.WriteLine("please enter file path (if you want to choose default file enter 'df'):");
            string outputPath, inputFile;
            inputFile = Console.ReadLine();
            outputPath = inputFile == "df"? MyProgram("C:/Users/osnat/OneDrive/Desktp/Hadasim/file.txt"):MyProgram(inputFile);
        ...
        public static string MyProgram(string filePath)
        {
            ...
            string kSec=null, kFullSequence=null, text = null, outputFile = "C:/Users/osnat/OneDrive/Desktop/Hadasim/output.txt";
            ...
            //         bigNumbers = { "hundred", "thousand", "million", "billion","hundreds", "thousands", "millions", "billions"  };
            //int buildNumber=0;

            //4.
            string[] allColors = { "blue", "black", "white", "red", "green", "orange", "grey", "pink", "purple" ,"light-blue"};
